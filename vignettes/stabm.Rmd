...
on the [mlbench::BostonHousing] data set.
...
We repeat this step 30 times and then calculate the Jaccard index on the list of character vectors of selected features:
```{r}
selected_features = replicate(30, fit_tree())
